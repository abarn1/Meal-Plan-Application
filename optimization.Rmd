...
lpmodel$A <- as.matrix(c(c(sub_nutrition$Protein, -protein_g),
#                      c(nutrition$Calcium..Ca, -calcium),
                      c(sub_nutrition$`Carbohydrate, by difference`, -carbs_g),
...
#                      c(nutrition$Sugars..total, -sugar),
                      c(sub_nutrition$`Total lipid (fat)`, -fat_g),
